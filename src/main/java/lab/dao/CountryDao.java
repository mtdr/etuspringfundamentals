...
public class CountryDao extends JdbcDaoSupport {
    ...
    public List<Country> getCountryList() {
        ...
        return jdbcTemplate.query("SELECT id, name, code_name from Country", COUNTRY_ROW_MAPPER);
    }
    ...
    public void updateCountryName(String codeName, String newCountryName) {
        NamedParameterJdbcTemplate namedParameterJdbcTemplate = new NamedParameterJdbcTemplate(
                getDataSource());
        SqlParameterSource sqlParameterSource = new MapSqlParameterSource(
                "name", newCountryName).addValue("code", codeName);
        namedParameterJdbcTemplate.update("UPDATE Country SET name = :name where code_name =:code",
                sqlParameterSource);
